...
global map_pretty sigma vidObj h;
    ...
    % draw vector field
    draw_field = 1;
    %quiver(1:10:300, 1:10:300, ddirect_x(1:10:300,1:10:300,draw_field), ...
               %                ddirect_y(1:10:300,1:10:300,draw_field),'Color',[.5,.5,.5]);
   ...
   plot(A(1,A(6,:)==1),A(2,A(6,:)==1),'o','MarkerSize',sigma,'MarkerEdgeColor','g','MarkerFaceColor','b'); %Punkte zeichnen
